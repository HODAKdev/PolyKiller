# from https://gist.github.com/poly-rodr/44313920481de58d5a3f6d1f8226bd5e + edited
...
def get_gas_params(web3):
    base_fee = web3.eth.get_block('latest')['baseFeePerGas']
    return {"maxFeePerGas": int(base_fee * 2), "maxPriorityFeePerGas": web3.to_wei(30, 'gwei')}
...
nonce = web3.eth.get_transaction_count(web3.to_checksum_address(pub_key), "pending")
...
nonce = web3.eth.get_transaction_count(web3.to_checksum_address(pub_key), "pending")
raw_ctf_approval_txn = ctf.functions.setApprovalForAll("0xC5d563A36AE78145C45a50134d48A1215220f80a", True).build_transaction({
    "chainId": chain_id,
    "from": pub_key,
    "nonce": nonce,
    **params
...
nonce = web3.eth.get_transaction_count(web3.to_checksum_address(pub_key), "pending")
raw_ctf_approval_txn = ctf.functions.setApprovalForAll("0xd91E80cF2E7be2e162c6513ceD06f1dD0dA35296", True).build_transaction({
    "chainId": chain_id,
    "from": pub_key,
    "nonce": nonce,
    **params
